/* eslint-disable react-refresh/only-export-components -- toast managers and helpers are not components */
"use client"
...
function showToast(
  ...
  const { description, type, ...rest } = options ?? {}
...
export const toast = Object.assign(
  (title: string, options?: ToastOptions) => showToast(title, options),
  {
    ...
    loading: (title: string, options?: ToastOptions) =>
      showToast(title, { ...options, type: "loading" }),
  }
)
